...
// import '../../../../app/response/aerator_automation_response.dart';
//
...
//
//   // Tracking original values to detect changes
...
//       _showSnackbar('Error', 'Please enter both Min and Max DO values', Colors.redAccent);
//       return;
//     }
//
...
//       _showSnackbar('Error', 'Please enter valid numeric values', Colors.redAccent);
//       return;
//     }
//
//     isSaving.value = true;
...
//       },
//       (r) {
//         _showSnackbar('Success', r.message ?? 'Settings saved successfully', Colors.green);
//         if (r.data != null) {
//            isAutomationEnabled.value = r.data!.isEnabled ?? false;
//            doMinController.text = r.data!.doMin?.toString() ?? '';
//            doMaxController.text = r.data!.doMax?.toString() ?? '';
